...
<p align="center">
  <img src="/assets/images/UKedge.jpg" alt="Woodland edge" 
       style="max-width:300px; border-radius:10px; margin: 0 10px;">
  <img src="/assets/images/UKinterior.jpg" alt="Woodland interior" 
       style="max-width:300px; border-radius:10px; margin: 0 10px;">
</p>
